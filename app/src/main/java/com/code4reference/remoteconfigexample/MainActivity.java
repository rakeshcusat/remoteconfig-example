package com.code4reference.remoteconfigexample;
...
//   @BindView(R.id.remote_config_value)
//   protected TextView remoteConfigValue;
...
//      ButterKnife.bind(this);
      ...
      defaultValues.put("enable_cardview_map", Boolean.FALSE);

      firebaseRemoteConfig.setDefaults(defaultValues);
      Log.d(TAG, String.format(Locale.ENGLISH, "Value: %s", firebaseRemoteConfig.getBoolean("enable_cardview_map")));
//      remoteConfigValue.setText(String.valueOf(firebaseRemoteConfig.getBoolean("enable_cardview_map")));

      // Light weight MapView
...
//   @OnClick(R.id.fetch_value_button)
...
//                                                String.format(Locale.ENGLISH, "Value: %s", firebaseRemoteConfig.getBoolean("enable_cardview_map")),
